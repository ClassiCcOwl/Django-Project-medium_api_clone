...
class ArticleReadTimeEngine:
    ...
    def estimate_reading_time(
        ...
        word_count_descriptions = ArticleReadTimeEngine.word_count(article.descriptions)

        total_word_count = word_count_body + word_count_title + word_count_descriptions
